...
#define FLOOD_SENSOR_Pin GPIO_PIN_1
#define FLOOD_SENSOR_GPIO_Port GPIOA
#define DHT22_PIN_Pin GPIO_PIN_2
#define DHT22_PIN_GPIO_Port GPIOA
#define BUZZER_PIN_Pin GPIO_PIN_13
#define BUZZER_PIN_GPIO_Port GPIOG
#define RELAY_PIN_Pin GPIO_PIN_14
#define RELAY_PIN_GPIO_Port GPIOG
